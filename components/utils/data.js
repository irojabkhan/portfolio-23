export const projects = [
  ...
  {
    thumbnail:
      "https://raw.githubusercontent.com/fortoszone/resource/main/MovieDB/MovieDB-Header%20image.png",
...
export const experiences = [
  {
    ...
    company_link: "https://wpdeveloper.com/",
    designation: "Front-End Developer",
    description:
      "WPDeveloper is a software product company focused on WordPress & SAAS product development.",
    description_list: [
      "Working as a productive and positive team member.",
      "Working on Shopify products and other SAAS products.",
      "Have experience in a react-native in-house app.",
    ],
    tags: [
      "React",
      "React Native",
  ...
  },
  {
    job_start: 2017,
    job_end: 2020,
    company_name: "CodePassenger",
    company_link: "https://themeforest.net/user/codepassenger",
    designation: "Web Designer",
    description:
      "CodePassenger Build WordPress Theme for Themeforest and served clients from different countries. CodePassenger's ThemeForest account got an elite badge in December 2018.",
    tags: [
      "HTML",
      "CSS",
      "SCSS",
  ...
  },
  {
    job_start: 2015,
    job_end: 2017,
    company_name: "Freelancing Place",
    designation: "Web Designer",
    description:
      "Freelancing place ltd. Inaugural herself in 2009 run with a strong IT team. We organize Freelance Outsourcing Training in our four office venue and with eLearning system also arrange awareness program to build in expert IT generation.",
    tags: [
      "HTML",
      "CSS",
      "SCSS",
